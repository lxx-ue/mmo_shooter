...
void ASTUPlayerCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
    ...
    PlayerInputComponent->BindAction("Reload", IE_Pressed, WeaponComponent, &USTUWeaponComponent::ChangeClip);

    DECLARE_DELEGATE_OneParam(FZoomInpitSignature, bool);
    PlayerInputComponent->BindAction<FZoomInpitSignature>("Zoom", IE_Pressed, WeaponComponent, &USTUWeaponComponent::Zoom, true);
    PlayerInputComponent->BindAction<FZoomInpitSignature>("Zoom", IE_Released, WeaponComponent, &USTUWeaponComponent::Zoom, false);
}
...
bool ASTUPlayerCharacter::IsRunnig() const
{
...
void ASTUPlayerCharacter::OnDeath() 
{
    ...
    if (Controller)
    {
        //передаем управление наблюдателю
